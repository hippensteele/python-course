...
__author__="tom"
__date__ ="$Apr 8, 2018 5:38:27 PM$"
...
yearLabel.grid(row=0, column=1, sticky='w')
...
daySpin.grid(row=0, column=0)
monthSpin.grid(row=0, column=1)
yearSpin.grid(row=0, column=2)
