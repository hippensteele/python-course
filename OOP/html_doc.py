...
__author__="tom"
__date__ ="$Apr 21, 2018 7:12:41 AM$"
...
class HtmlDocComposite(HtmlDoc):
...
class HtmlDocAggregate(HtmlDoc):
...
if __name__ == '__main__':
    ...
    my_page = HtmlDocComposite(title="Composition")
    ...
    safari.open_new("/Users/tom/CPMC/CPMC/src/OOP/test.html")
    ...
    new_page = HtmlDocAggregate(new_doctype, new_header, new_body)
    with open("test2.html", 'w') as test_doc:
        new_page.display(file=test_doc)
    safari.open_new("/Users/tom/CPMC/CPMC/src/OOP/test2.html")